...
if("FALSE" STREQUAL "TRUE")
  set(hector_trajectory_server_SOURCE_PREFIX /home/sergiogq/hector_quadrotor_tutorial/src/hector_slam/hector_trajectory_server)
  set(hector_trajectory_server_DEVEL_PREFIX /home/sergiogq/hector_quadrotor_tutorial/devel)
  ...
  set(hector_trajectory_server_INSTALL_PREFIX /home/sergiogq/hector_quadrotor_tutorial/install)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'hector_trajectory_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sergiogq/hector_quadrotor_tutorial/install/${idir}'.  Ask the maintainer 'Johannes Meyer <meyer@fsr.tu-darmstadt.de>' to fix it.")
    endif()
